...
{`Hello [Name],
I hope you're doing well. I'm a pre-final year student at E.G.S. Pillay Engineering College specializing in [Your Department]. I'm highly interested in the [Job Title] role at [Company] (Requisition ID: [ID]). Could you please review my profile for a potential referral?
Thanks!`}
                </pre>
              </div>
...
My name is [Your Name], currently pursuing my B.E. in [Your Department] at E.G.S. Pillay Engineering College. I came across the open role of [Job Title] (ID: [Requisition ID]) at [Company] and felt my technical background in [list 2 skills, e.g. React / Node.js or Microcontrollers] aligns well with your team's goals.
